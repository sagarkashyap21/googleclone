...
export default function Navbar() {
    ...
    return (
       ...
       <div style={{}}>
           <ul className="navul" style={{listStyle:"none",marginTop:"10px",display:"flex",justifyContent:"flex-end",alignItems:"center",marginRight:"10px"}}>
            ...
            <li style={{}}><a href=""><img style={{height:"50px",borderRadius:"50px",width:"50px"}} src="https://images.unsplash.com/photo-1673981171808-549ab1f51f1c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwyfHx8ZW58MHx8fHw%3D&auhref=format&fit=crop&w=500&q=60" alt="" /></a></li>
           </ul>
